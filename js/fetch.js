...
async function getLista() {
    const response = await fetch("https://test-d2273.firebaseio.com/.json");
...
async function del(idx) {
    if (confirm(`are you sure you want to delete ${lista[idx].name}?`)) {
        await fetch(`https://test-d2273.firebaseio.com/${idx}.json`, {
            method: "DELETE"
        });
        await getLista();
    }
...
async function add() {
    ...
    */
    ...
    if (idxEdit === null) {
        ...
        await fetch(`https://test-d2273.firebaseio.com/.json`,{
            method: "POST",
